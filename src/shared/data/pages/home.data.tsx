...
export const heroHome: HeroProps = {
  title: (
    <>
      Study Abroad <span className="hidden md:inline">with</span>{' '}
      <span>Study Hub Internation Education Consultancy</span>
    </>
  ),
  subtitle: (
    <>
      <span className="hidden md:inline">
        <span className="font-semibold  decoration-primary-600 decoration-wavy decoration-1 underline-offset-2">
          We Study Hub International Education Consultancy
        </span>{' '}
        is one of the best institute for international education . We can help students who willing to apply for
        International university then we always support them.
      </span>{' '}
      We also have classes like IELTS, German & Korean.
    </>
  ),
  callToAction: {
    text: 'About Us',
